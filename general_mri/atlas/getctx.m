function data_new=getctx(data,ctxtype,atlascategory,varargin)
% Example: mat_new=getctx(icc{2,6}{51},'cortex','subnetwork')
...
load(sprintf('map%0.0f_%s.mat',atlasdim,atlascategory));
