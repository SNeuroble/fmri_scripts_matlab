function reordered_mat = reorder_matrix_atlas(orig_data,category)
% orig mat is nxixi; typically a cell mat of connectivity matrix
% e.g., reordered_mat = reorder_matrix_atlas(orig_mat)
% Don't use this natively to summarize ROIs; domatrixsummary_XXX to organize

if iscell(orig_data); matdim=size(orig_data{1});
