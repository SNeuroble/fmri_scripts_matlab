function summary_matrix=domatrixsummary_avg(mat,varargin)
...
% e.g., domatrixsummary_avg(mat,'atlascategory','lobe','datacategory','ICC','reorderimg',1);
...
load(sprintf('map%0.0f_%s.mat',matdim,atlascategory));
...
if ~suppressimg
    ...
    drawmatrix_atlas(combined_summary,'atlascategory',atlascategory,'datacategory',datacategory,'saveimg',saveimg);
end
